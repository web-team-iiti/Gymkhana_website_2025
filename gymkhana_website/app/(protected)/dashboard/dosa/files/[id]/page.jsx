...
import { FaUser, FaCalendarAlt, FaHistory, FaFilePdf, FaExternalLinkAlt, FaFileSignature } from "react-icons/fa";
import ActionButtons from "./ActionButtons"; // DOSA Specific Buttons
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
      ...
      <div className="lg:col-span-8 space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 p-6 md:p-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 leading-relaxed border-l-4 border-green-500/50 pl-4 mb-6">
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        {/* ACTION BUTTONS (The Approver Logic) */}
          ...
          <div className="space-y-6 relative pl-2">
            ...
            {logs.map((log, index) => (
                <div key={log.id} className="relative z-10 flex gap-4">
                    <div className={`w-14 h-14 rounded-full border-4 border-gray-900 flex items-center justify-center shrink-0 shadow-lg ${index === 0 ? 'bg-green-600 text-white' : 'bg-gray-800 text-gray-500'}`}>
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-yellow-600 uppercase font-bold">{log.actor_role?.replace('_', ' ')}</p>
                        {log.remark && <p className="text-xs text-gray-400 italic mt-1 bg-gray-950 p-2 rounded border border-gray-800">"{log.remark}"</p>}
                    </div>
                </div>
            ))}
          </div>
