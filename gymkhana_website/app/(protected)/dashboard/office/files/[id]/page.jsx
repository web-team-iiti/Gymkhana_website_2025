...
import { FaUser, FaClock, FaCalendarAlt, FaHistory, FaFileAlt, FaFilePdf, FaExternalLinkAlt, FaExpand } from "react-icons/fa";
...
export default async function ReviewPage({ params }) {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
            ...
            {/* LEFT COLUMN: Details & PDF (Takes up 8 columns on Desktop, Full width on Mobile) */}
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-gray-800/50">
                            <div className="flex items-center gap-3 bg-gray-950/30 p-3 rounded-xl border border-gray-800/50">
                                ...
                                <div className="min-w-0"> {/* min-w-0 allows text truncation */}
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl relative group transition-all duration-300 hover:shadow-yellow-500/10 hover:border-gray-700">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-gray-950 border-b border-gray-800">
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-900 border border-gray-800 text-gray-400 text-xs font-medium hover:text-white hover:border-gray-600 transition-all group/btn"
                        >
                            <span>Open</span>
                    ...
                    {/* --- MOBILE VIEW: "Tap to Open" Card (Visible only on small screens) --- */}
                    <div className="md:hidden h-[300px] flex flex-col items-center justify-center bg-gray-900 p-6 text-center">
                        ...
                        <p className="text-gray-500 text-xs mb-6 max-w-[250px] leading-relaxed">
                            Mobile browsers cannot verify secure documents inside this window. Please open the file directly.
                        </p>
                        <a
                            href={proposal.pdf_url}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-xl font-bold text-sm shadow-lg shadow-yellow-500/20 active:scale-95 transition-transform flex items-center gap-2"
                        >
                    ...
                    {/* --- DESKTOP VIEW: The Iframe (Hidden on mobile) --- */}
                    <div className="hidden md:flex relative h-[800px] bg-gray-800 w-full overflow-hidden flex-col">
                        ...
                        <iframe
                            ...
                            className="relative z-10 w-full h-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']"
                            title="Proposal PDF"
                            loading="lazy"
                        />
                    </div>
            ...
            {/* RIGHT COLUMN: Actions & Timeline (Takes up 4 columns on Desktop, Full width on Mobile) */}
