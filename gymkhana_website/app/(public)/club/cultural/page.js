...
import CulturalBackground from "@/components/cult-background";
    ...
    <div className="min-h-screen bg-gray-950/1 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-pink-700 via-pink-400 to-yellow-400 bg-clip-text text-transparent animate-gradient">
            Cultural Clubs
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    return (
                      ...
                      >
                        ...
                        {hoveredClub === actualIndex && (
                          <div className="absolute inset-0 bg-gray-900/80 backdrop-blur-md rounded-xl p-4 flex items-center justify-center border border-pink-400 animate-fadeIn z-20 overflow-hidden">
                ...
                >
                  {[...clubHeads, ...clubHeads, ...clubHeads].map((head, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 h-64 flex flex-col items-center justify-center border border-gray-700 hover:border-pink-500 hover:bg-gray-700/50 transition-all duration-300">
                          ...
                          <p className="text-pink-400 mb-1 text-xs font-medium text-center line-clamp-1">
                            {head.role}
                          </p>
                          ...
                          {hoveredHead === actualIndex && (
                            <div className="flex justify-center gap-3 mt-2 animate-fadeIn">
                              <a
                                ...
                                className="bg-gradient-to-r from-purple-600 to-pink-600 p-2 rounded-full hover:scale-110 transition-transform shadow-lg hover:shadow-pink-400/50"
                              >
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800 shadow-2xl h-full">
              <h3 className="text-2xl font-bold mb-4 text-center text-pink-400">Gallery</h3>
              <div
                ref={galleryRef}
